...
$$\left\{\begin{array}{ c @{{}{}} l  @{{}{}} r }\textrm{Logit}(Prob(Y_{ij}>0)) &= \beta_{10} + b_{i10} + (\beta_{11} + b_{i11})year_{ij} + \beta_{12}drug_{i} + \beta_{13}year_{ij}drug_{i}  & \text{(L1)}\\
...
\lambda_{i1}(t) &=\lambda_{01}(t)\ \textrm{exp}\left(\gamma_{11}Chemo_i + \varphi_{11}b_{i10} + \varphi_{12}b_{i11} + \varphi_{13}b_{i20} + \varphi_{14}b_{i21} + \omega_i \right)  & \text{(S1)}\\
\lambda_{i2}(t) &=\lambda_{02}(t) \textrm{exp}\left(\gamma_{12}Chemo_i + \varphi_{21}b_{i10} + \varphi_{22}b_{i11} + \varphi_{23}b_{i20} + \varphi_{24}b_{i21} + \varphi_{25}\omega_i\right)  & \text{(S2)}\\
\end{array}\right.
$$
