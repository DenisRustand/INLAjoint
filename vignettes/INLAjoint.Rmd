...
$$\left\{
\begin{array}{ c @{{}{}} l  @{{}{}} r }\log(serBilir_{ij}) &= \eta_{i1}(t_{ij}) + \varepsilon_{ij1} = \beta_{10} + b_{i10} + \beta_{11}year_{ij} + \beta_{12}drug_{i} + \beta_{13}sex_i & \text{(L1)} \\
& \ \ \ + \beta_{14}year_{ij}drug_{i} + \varepsilon_{ij1}\\
\log(E[platelets_{ij}]) &= \eta_{i2}(t_{ij}) = \beta_{20} + b_{i20} + \beta_{21}year_{ij} + \beta_{22}sex_i + \beta_{23}drug_{i} + \beta_{24}year_{ij}sex_{i} & \text{(L2)}\\
\text{logit}(E[spiders_{ij}]) &= \eta_{i3}(t_{ij}) = \beta_{30} + b_{i30} + \beta_{31}year_{ij} + \beta_{32}drug_{i} + \beta_{33}year_{ij}drug_{i}  & \text{(L3)}\\
\lambda_{i1}(t)&=\lambda_{01}(t)\ \textrm{exp}\left(\gamma_{11}drug_i + \varphi_{11}\eta_{i1}(t) + \varphi_{12}b_{i20} + \varphi_{13}\eta_{i3}(t) + \varphi_{14}\eta_{i3}'(t)\right) & \text{(S1)}\\
...
M9 <- joint(formLong = list(serBilir ~ (1 + f1(year) + f2(year) + f3(year)) * drug + 
            ...
            assoc = list(c("CV_CS", "CV"),  c("CV", ""), c("CV", "CV"), 
                         c("CV", "CV"), c("CV", "")),
            control=list(priorFixed=list(mean=0, prec=1, 
